...
#define CAS32(mem, oldv, newv)                                                 \
    __atomic_compare_exchange_n(&mem, &oldv, newv, 0, __ATOMIC_SEQ_CST,        \
                                __ATOMIC_SEQ_CST)
...
#define ATOMIC_ADD32_PTR(mem, val)                                             \
    __atomic_add_fetch(mem, val, __ATOMIC_SEQ_CST)
...
#define XCHANGE64(mem, newv) __fetch_and_swap(&mem, newv)
