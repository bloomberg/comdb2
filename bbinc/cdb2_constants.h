...
#define MAXBLOBLENGTH2 (0x7fffffff - 16) /* odh2 cap: payload + 16-byte header must fit in an int */
...
#define MAX_RETENTION MAX_NUM_TABLES
...
#define NON_ALPHANUM_CHARS_ALLOWED_IN_MACHINENAME "-"
#define NON_ALPHANUM_CHARS_ALLOWED_IN_DBNAME "_-"
