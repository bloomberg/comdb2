...
/*
** NOTE: This function is in the critical path during the "prepase phase" of
**       SQL query execution.  It ends up getting called every time a table
**       needs to be located.  To avoid potential deadlocks, a transaction
