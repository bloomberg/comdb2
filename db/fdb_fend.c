 ...
 *
 */
int sqlite3AddAndLockTable(sqlite3 *db, const char *dbname, const char *table, int *version, int *out_class,
...
/* TODO: call this from osql_clnt_clean */
static void fdb_clnt_cache_destroy(clnt_fdb_cache_t *cache)
{
