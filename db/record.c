...
extern int add_record_indices(struct ireq *iq, void *trans, 
...
extern int del_record_indices(struct ireq *iq, void *trans, int *opfailcode,
...
extern int upd_new_record_indices(struct ireq *iq, void *trans,
