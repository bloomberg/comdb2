...
comdb2_metric gbl_metrics[] = {
    ...
    {"async_wait_queue_time", "Average ms spent waiting in async-wait queue", STATISTIC_DOUBLE,
     STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_queue_time, NULL},
    {"async_wait_init_time", "Average ms spent waiting in async-wait queue in the init phase", STATISTIC_DOUBLE,
     STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_init_time, NULL},
    {"async_wait_wait_for_first_ack_time",
     "Average ms spent waiting in async-wait queue in the wait_for_first_ack phase", STATISTIC_DOUBLE,
     STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_wait_for_first_ack_time, NULL},
    {"async_wait_wait_for_all_ack_time", "Average ms spent waiting in async-wait queue in the wait_for_all_ack phase",
     STATISTIC_DOUBLE, STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_wait_for_all_ack_time, NULL},
    {"async_wait_wait_finish_time", "Average ms spent waiting in async-wait queue in the wait_finish phase",
     STATISTIC_DOUBLE, STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_wait_finish_time, NULL},
    {"async_wait_wait_next_commit_timestamp_time",
     "Average ms spent waiting in async-wait queue in the wait_next_commit_timestamp phase", STATISTIC_DOUBLE,
     STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_wait_next_commit_timestamp_time, NULL},
    {"async_wait_wait_notify_time", "Average ms spent waiting in async-wait queue in the wait_notify phase",
     STATISTIC_DOUBLE, STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_wait_notify_time, NULL},
    {"async_wait_time_before_first_access", "Average ms spent waiting in async-wait queue before first being accessed",
     STATISTIC_DOUBLE, STATISTIC_COLLECTION_TYPE_LATEST, &stats.async_wait_time_before_first_access, NULL},
    {"block_processor_time", "Average ms spent by a block processor thread on one request", STATISTIC_DOUBLE,
     STATISTIC_COLLECTION_TYPE_LATEST, &stats.bp_time, NULL},
...
int refresh_metrics(void)
{
    ...
    stats.async_wait_queue_time = time_metric_average(thedb->async_wait_queue_time);
    stats.async_wait_init_time = time_metric_average(thedb->async_wait_init_time);
    stats.async_wait_wait_for_first_ack_time = time_metric_average(thedb->async_wait_wait_for_first_ack_time);
    stats.async_wait_wait_for_all_ack_time = time_metric_average(thedb->async_wait_wait_for_all_ack_time);
    stats.async_wait_wait_finish_time = time_metric_average(thedb->async_wait_wait_finish_time);
    stats.async_wait_wait_next_commit_timestamp_time =
        time_metric_average(thedb->async_wait_wait_next_commit_timestamp_time);
    stats.async_wait_wait_notify_time = time_metric_average(thedb->async_wait_wait_notify_time);
    stats.async_wait_time_before_first_access = time_metric_average(thedb->async_wait_time_before_first_access);
