                             ...
                             struct sql_thread *thd)
{
    ...
    if (clnt->dbtran.crtchunksize >= clnt->dbtran.maxchunksize) {
        ...
        int continued_on_verify_error = (clnt->continue_on_verify_error && rc == CDB2ERR_VERIFY_ERROR);
        if (rc) {
            comdb2_sqlite3VdbeError(pCur->vdbe,
