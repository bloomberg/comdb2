...
extern int gbl_osql_send_clientinfo;
...
extern int gbl_pagelock_release_interval_ms;
extern int gbl_pagelock_release_max_wait_ms;
extern int gbl_pagelock_split_waiters;
...
extern int gbl_lock_instrumentation_sample;
