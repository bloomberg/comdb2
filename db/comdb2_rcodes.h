...
enum comdb2_import_op {
    ...
    COMDB2_IMPORT_RC_NOT_ENABLED = 12014,             /* Bulk import is not enabled */
    COMDB2_IMPORT_RC_DIFF_TABLES_NOT_ENABLED = 12015, /* Import across different table names is not enabled */
};
