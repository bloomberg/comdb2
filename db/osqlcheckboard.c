 ...
 * as soon as it stops waiting (rollback, disconnect, timeout) while a reply
 * from master may still be landing.  Lock/unlock to wait it out; destroying
 * the mutex underneath it returns EBUSY and aborts.
 */
