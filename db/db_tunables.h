...
REGISTER_TUNABLE("debug_sleep_on_partition_analyze", "Sleep for 'n' seconds after releasing views lock in partition analyze (Default: 0)",
                 TUNABLE_INTEGER, &gbl_debug_sleep_on_partition_analyze, INTERNAL, NULL, NULL, NULL, NULL);
