...
REGISTER_TUNABLE("reproduce_ckp_bug", "Allow full-recovery ckp-gen to exceed cluster generation.  (Default: off)", TUNABLE_BOOLEAN,
                 &gbl_reproduce_ckp_bug, 0, NULL, NULL, NULL, NULL);
