...
REGISTER_TUNABLE("poll_in_pgfree_recover", "Poll pgfree recovery handler.",
                 ...
                 EXPERIMENTAL | INTERNAL, NULL, NULL, NULL, NULL);
REGISTER_TUNABLE("sequence_replicant_distribution", "Distribute sequence values from replicants. Monotonicity not guaranteed",
                 TUNABLE_BOOLEAN, &gbl_sequence_replicant_distribution,
                 READONLY, NULL, NULL, NULL, NULL);
