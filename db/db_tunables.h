...
REGISTER_TUNABLE("verify_error_on_table_find_miss", "Any find on a rowid that doesn't find a record returns a verify error (Default: on",
                 TUNABLE_BOOLEAN, &gbl_verify_error_on_table_find_miss, INTERNAL, NULL, NULL, NULL, NULL);
