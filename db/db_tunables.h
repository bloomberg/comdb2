...
REGISTER_TUNABLE("sql_row_delay_msecs",
                 "Add this delay before sending back a row, for every row (default: 0)", TUNABLE_INTEGER,
                 &gbl_sql_row_delay_msecs, 0, NULL, NULL, NULL, NULL);
REGISTER_TUNABLE("thread_wait_sec",
                 "Wait that many seconds for each thread to exit during a clean exit (default: 5)", TUNABLE_INTEGER,
                 &gbl_thread_wait_sec, 0, NULL, NULL, NULL, NULL);
