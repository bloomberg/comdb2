...
REGISTER_TUNABLE("name", NULL, TUNABLE_STRING, &gbl_name,
                 DEPRECATED_TUNABLE | READONLY, NULL, NULL, NULL, NULL);
...
REGISTER_TUNABLE("early_ack_trace",
                 ...
                 NULL, NULL, NULL, NULL);
REGISTER_TUNABLE("commit_delay_timeout_seconds", "Set timeout for commit-delay on copy.  "
                 "(Default: 10)", TUNABLE_INTEGER, &gbl_commit_delay_timeout, 0, NULL, NULL, NULL, NULL);
REGISTER_TUNABLE("commit_delay_on_copy_ms", "Set automatic delay-ms for commit-delay on copy.  "
                 "(Default: 0)", TUNABLE_INTEGER, &gbl_commit_delay_copy_ms, 0, NULL, NULL, NULL, NULL);
