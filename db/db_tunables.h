...
REGISTER_TUNABLE("maxlsn_on_catchup", "If we're catching up to the master, report max LSN (default: off)", TUNABLE_BOOLEAN, &gbl_maxlsn_on_catchup, 0, NULL, NULL, NULL, NULL);
