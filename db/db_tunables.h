...
REGISTER_TUNABLE("debug_trace_sorter_rewind",
                 "Log the wall time spent in the sqlite sorter's rewind step (testing only).  That call is the "
                 "sort's blocking window; query wall time cannot stand in for it.  (Default: off)",
