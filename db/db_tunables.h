...
REGISTER_TUNABLE("gofast", NULL, TUNABLE_BOOLEAN, &gbl_goslow,
                 INVERSE_VALUE | NOARG, NULL, NULL, NULL, NULL);
REGISTER_TUNABLE("group_concat_memory_limit",
                 "Restrict GROUP_CONCAT from using more than this amount of "
                 "memory, 0 implies unlimited (Default: 255 * 1024 * 1024)",
                 TUNABLE_INTEGER, &gbl_group_concat_mem_limit, READONLY, NULL,
                 NULL, NULL, NULL);
