...
REGISTER_TUNABLE("iam_dbname",
                 ...
                 NULL, NULL, NULL);
REGISTER_TUNABLE("comdb2_files_sleep_after_processing_llmeta", "Sleep after processing llmeta in comdb2 files query processor\n", TUNABLE_BOOLEAN, &gbl_comdb2_files_sleep_after_processing_llmeta,
                 INTERNAL, NULL, NULL, NULL, NULL);
