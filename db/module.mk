...
db_SOURCES:=db/comdb2.c db/endian.c db/handle_buf.c db/sltdbt.c		\
    ...
    db/sqlglue.c db/sqlsupport.c db/sqlinterfaces.c			\
    db/sqlexplain.c db/verify.c db/constraints.c db/plink_timestamp.o	\
    db/prefault.c db/prefault_toblock.c db/prefault_net.c		\
    db/prefault_readahead.c db/prefault_helper.c db/thrman.c		\
    db/pushlogs.c db/errstat.c db/socket_interfaces.c db/reqlog.c	\
    db/twophase.c db/sqloffload.c db/mtrap.c db/toproxy.c		\
    db/repl_wait.c db/utf8.c db/osqlsession.c				\
    ...
    db/sqlstat1.c db/sqlanalyze.c db/watchdog.c				\
    db/translistener.c db/osqlblkseq.c db/lrucache.c db/testcompr.c	\
    db/fdb_util.c db/fdb_fend.c db/fdb_boots.c db/fdb_bend.c		\
    db/fdb_bend_sql.c db/fdb_comm.c db/fdb_fend_cache.c			\
    db/fdb_access.c db/envstubs.c db/comdb2uuid.c			\
