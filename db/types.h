...
struct dbtable;
struct schema;
int extract_decimal_quantum(const struct dbtable *db, int ix, char *inbuf, char *outbuf,
                            int outbuf_max, int *outlen);
short field_decimal_quantum(const struct dbtable *db, struct schema *s, int fnum, 
...
int odhfy_blob_buffer(const struct dbtable *db, blob_buffer_t *blob, int blobind);
