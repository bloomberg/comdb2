...
struct global_stats {
    ...
    uint64_t failed_page_reads;
    uint64_t failed_page_writes;
    uint64_t fsyncs;
    uint64_t mempgets;
    uint64_t page_bytes_read;
    uint64_t page_bytes_written;
    uint64_t failed_page_bytes_read;
    uint64_t failed_page_bytes_written;
};
