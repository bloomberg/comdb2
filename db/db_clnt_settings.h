...
REGISTER_ACC_SETTING(tzname, timezone, SETTING_STRING, 0, gbl_setting_default_query_timeout);
REGISTER_ACC_SETTING(dtprec, datetime, SETTING_STRING, 0, gbl_setting_default_query_timeout);
...
// REGISTER_SETTING(current_user, "", SETTING_COMPOSITE, 0, gbl_setting_default_query_timeout);
// REGISTER_ACC_SETTING(current_user.name, "", SETTING_STRING, SETFLAG_DERIVED, gbl_setting_default_query_timeout);
// REGISTER_SETTING(current_user.is_x509_user, "", SETTING_INTEGER, SETFLAG_DERIVED, gbl_setting_default_query_timeout);
// REGISTER_SETTING(current_user.have_password, "", SETTING_INTEGER, SETFLAG_DERIVED,
// gbl_setting_default_query_timeout); REGISTER_ACC_SETTING(authgen, "", SETTING_COMPOSITE, 0,
