...
REGISTER_ACC_SETTING(plugin.set_timeout, timeout, SETTING_COMPOSITE, 0, gbl_setting_default_query_timeout);
REGISTER_ACC_SETTING(query_timeout, maxquerytime, SETTING_LONG, 0, gbl_setting_default_query_timeout)
REGISTER_ACC_SETTING(tzname, timezone, SETTING_STRING, 0, gbl_setting_default_timezone);
REGISTER_ACC_SETTING(dtprec, datetime, SETTING_STRING, 0, gbl_setting_default_timezone);

REGISTER_SETTING(current_user, SETTING_COMPOSITE, 0, 0);
REGISTER_ACC_SETTING(current_user.name, user, SETTING_STRING, 0, gbl_setting_default_user);
REGISTER_ACC_SETTING(current_user.password, password, SETTING_STRING, 0, gbl_setting_default_password);
REGISTER_ACC_SETTING(spversion.version_str, spversion, SETTING_COMPOSITE, 0, gbl_setting_default_spversion);
...
REGISTER_ACC_SETTING(fdb_state.access, remote, SETTING_COMPOSITE, 0, gbl_setting_default_remote);
