                          ...
                          host_node_type *host_node_ptr, SBUF2 *sb)
{
    ...
    if (gbl_libevent) {
        ...
        return write_connect_message_bufferevent(host_node_ptr, iov, n);
    }
                        ...
                        int inorder, int trace)
{
    if (gbl_libevent) {
        ...
        if (nodrop)
            f |= NET_SEND_NODROP;
        return net_send_bufferevent(netinfo_ptr, host, usertype, data, datalen,
