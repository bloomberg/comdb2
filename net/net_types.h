...
enum {
    ...
    USER_TYPE_UDP_ACK = 25,
    USER_TYPE_UDP_PING = 26,
    USER_TYPE_UDP_TIMESTAMP = 27,
    USER_TYPE_UDP_TIMESTAMP_ACK = 28,
    USER_TYPE_UDP_PREFAULT = 29,
    USER_TYPE_TCP_TIMESTAMP = 30,
    USER_TYPE_TCP_TIMESTAMP_ACK = 31,
    USER_TYPE_PING_TIMESTAMP = 32,
    USER_TYPE_PING_TIMESTAMP_ACK = 33,
    USER_TYPE_ANALYZED_TBL = 34,
    USER_TYPE_COHERENCY_LEASE = 35,
    USER_TYPE_PAGE_COMPACT = 36,

    /* by hostname messages */
    //USER_TYPE_DECOM_NAME_DEPRECATED = 37,
    USER_TYPE_ADD_NAME = 38,
    USER_TYPE_DEL_NAME = 39,
    USER_TYPE_TRANSFERMASTER_NAME = 40,
    USER_TYPE_REQ_START_LSN = 41,
    USER_TYPE_TRUNCATE_LOG = 42,
    ...
    //NET_USE_LLMETA = 129,            /* deprecated, in this version of comdb2, all dbs must be llmeta */
