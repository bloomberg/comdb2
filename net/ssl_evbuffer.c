...
static struct ssl_handshake_arg *new_foo(SSL **ssl, int fd, struct event_base *base, ssl_evbuffer_cb *error_cb, ssl_evbuffer_cb *success_cb, void *data)
{
...
{
    struct ssl_handshake_arg *arg = new_foo(ssl, fd, base, error_cb, success_cb, data);
