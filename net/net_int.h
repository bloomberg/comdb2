...
const uint8_t *net_send_message_header_put(const net_send_message_header *, uint8_t *, const uint8_t *);
...
int net_flush_bufferevent(host_node_type *);
int net_send_all_bufferevent(netinfo_type *, int, void **, int *, int *, int *);
void rem_from_netinfo(netinfo_type *, host_node_type *);
int write_connect_message(netinfo_type *, host_node_type *, SBUF2 *);
int write_connect_message_bufferevent(host_node_type *, const struct iovec *, int);
...
int write_list_bufferevent(host_node_type *, int, const struct iovec *, int, int);
int net_send_bufferevent(netinfo_type *, const char *, int, void *, int, int, void **, int *, int);
