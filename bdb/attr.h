...
DEF_ATTR(DOHSQL_VERBOSE, dohsql_verbose, BOOLEAN, 0, NULL)
DEF_ATTR(DOHAST_VERBOSE, dohast_verbose, BOOLEAN, 0, NULL)
DEF_ATTR(DOHSQL_DISABLE, dohsql_disable, BOOLEAN, 0, NULL)
DEF_ATTR(DOHAST_DISABLE, dohast_disable, BOOLEAN, 0, NULL)
