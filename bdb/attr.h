...
DEF_ATTR(VIEWS_DFT_PREEMPT_ROLL_SECS, views_dft_preempt_roll_secs, SECS, 1800, 
         "Amount of seconds to run phase 1 of time partition rollout before phase 2")
DEF_ATTR(VIEWS_DFT_ROLL_DELETE_LAG_SECS, views_dft_roll_delete_lag_secs, SECS, 5,
