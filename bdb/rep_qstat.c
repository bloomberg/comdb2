...
int rep_qstat_tunable_track(void *context, void *reptype)
{
    char *repstr = (char *)reptype;
    int _reptype = atoi(repstr);
    rep_qstat_track(_reptype);
    return 0;
}

int rep_qstat_tunable_untrack(void *context, void *reptype)
{
    char *repstr = (char *)reptype;
    int _reptype = atoi(repstr);
    rep_qstat_untrack(_reptype);
    return 0;
}
