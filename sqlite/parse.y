...
/* BEGIN/COMMIT/ROLLBACK is not handled here. */
%ifdef COMDB2_UNHANDLED
...
//
  ...
  COMMIT COMMITSLEEP CONSUMER CONVERTSLEEP COVERAGE CRLE DATA DATABLOB DATACOPY
  DBPAD DEFERRABLE DISABLE DRYRUN ENABLE FOR FUNCTION GENID48 GET GRANT
  ...
  TRANSACTION TRUNCATE TUNABLE VERSION WRITE DDL USERSCHEMA ZLIB.
%wildcard ANY.
