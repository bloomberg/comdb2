...
// COMDB2 KEYWORDS  
  ...
  CONVERTSLEEP COVERAGE CRLE DATA DATABLOB DATACOPY DBPAD DISABLE ENABLE FOR
  FUNCTION GET GRANT IPU ISC KW LUA LZ4 NONE ODH OFF OP OPTIONS PARTITION
  PASSWORD PERIOD PROCEDURE PUT REBUILD READ REC RESERVED RETENTION REVOKE
  RLE ROWLOCKS SCALAR SCHEMACHANGE START SUMMARIZE THREADS THRESHOLD TIME
