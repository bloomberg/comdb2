...
// COMDB2 KEYWORDS
  ...
  ENABLE FOREIGN FUNCTION GENID48 GET GRANT IPU ISC KW LUA LZ4 NONE
  NOTHING ODH OFF OP OPTION OPTIONS
  PAGEORDER PASSWORD PERIOD PROCEDURE PUT
  READ READONLY REBUILD REC REFERENCES RESERVED RETENTION REVOKE RLE ROWLOCKS
