  ...
  while( pCur->ePhase!=COMPLETION_EOF ){
    switch( pCur->ePhase ){
      ...
      case COMPLETION_FUNCTIONS: {
        static char *cfuncs[] = {"comdb2_version()", "table_version()", "partition_info()", "comdb2_host()", "comdb2_port()", "comdb2_dbname()", "comdb2_prevquerycost()", "comdb2_uptime()", "comdb2_starttime()", "sys.cmd.send()"};
        static int j = 0;
