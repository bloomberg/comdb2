...
int systblRepNetQueueStatInit(sqlite3 *db) {
    return create_system_table(db, "comdb2_replication_netqueue",
            ...
            CDB2_CSTRING, "min_lsn", -1, offsetof(systable_rep_qstat_t, min_lsn),
            CDB2_CSTRING, "max_lsn", -1, offsetof(systable_rep_qstat_t, max_lsn),
            CDB2_INTEGER, "alive", -1, offsetof(systable_rep_qstat_t, alive),
            CDB2_INTEGER, "alive_req", -1, offsetof(systable_rep_qstat_t, alive_req),
            CDB2_INTEGER, "all_req", -1, offsetof(systable_rep_qstat_t, all_req),
            CDB2_INTEGER, "dupmaster", -1, offsetof(systable_rep_qstat_t, dupmaster),
            CDB2_INTEGER, "file", -1, offsetof(systable_rep_qstat_t, file),
            CDB2_INTEGER, "file_req", -1, offsetof(systable_rep_qstat_t, file_req),
            CDB2_INTEGER, "log", -1, offsetof(systable_rep_qstat_t, log),
            CDB2_INTEGER, "log_more", -1, offsetof(systable_rep_qstat_t, log_more),
            CDB2_INTEGER, "log_req", -1, offsetof(systable_rep_qstat_t, log_req),
            CDB2_INTEGER, "master_req", -1, offsetof(systable_rep_qstat_t, master_req),
            CDB2_INTEGER, "newclient", -1, offsetof(systable_rep_qstat_t, newclient),
            CDB2_INTEGER, "newfile", -1, offsetof(systable_rep_qstat_t, newfile),
            CDB2_INTEGER, "newmaster", -1, offsetof(systable_rep_qstat_t, newmaster),
            CDB2_INTEGER, "newsite", -1, offsetof(systable_rep_qstat_t, newsite),
            CDB2_INTEGER, "page", -1, offsetof(systable_rep_qstat_t, page),
            CDB2_INTEGER, "page_req", -1, offsetof(systable_rep_qstat_t, page_req),
            CDB2_INTEGER, "plist", -1, offsetof(systable_rep_qstat_t, plist),
            CDB2_INTEGER, "plist_req", -1, offsetof(systable_rep_qstat_t, plist_req),
            CDB2_INTEGER, "verify", -1, offsetof(systable_rep_qstat_t, verify),
            CDB2_INTEGER, "verify_fail", -1, offsetof(systable_rep_qstat_t, verify_fail),
            CDB2_INTEGER, "verify_req", -1, offsetof(systable_rep_qstat_t, verify_req),
            CDB2_INTEGER, "vote1", -1, offsetof(systable_rep_qstat_t, vote1),
            CDB2_INTEGER, "vote2", -1, offsetof(systable_rep_qstat_t, vote2),
            CDB2_INTEGER, "log_logput", -1, offsetof(systable_rep_qstat_t, log_logput),
            CDB2_INTEGER, "pgdump_req", -1, offsetof(systable_rep_qstat_t, pgdump_req),
            CDB2_INTEGER, "gen_vote1", -1, offsetof(systable_rep_qstat_t, gen_vote1),
            CDB2_INTEGER, "gen_vote2", -1, offsetof(systable_rep_qstat_t, gen_vote2),
            CDB2_INTEGER, "log_fill", -1, offsetof(systable_rep_qstat_t, log_fill),
            CDB2_INTEGER, "uncategorized", -1, offsetof(systable_rep_qstat_t, uncategorized),
            CDB2_INTEGER, "unknown", -1, offsetof(systable_rep_qstat_t, unknown),
