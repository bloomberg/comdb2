...
#define SQLITE_TRAN_CANCELLED 205 /* resource had to be freed, transaction was aborted */
#define SQLITE_TRAN_NOLOG     206 /* log has been freed, unable to maintain snapshot */
#define SQLITE_TRAN_NOUNDO  207   /* the database suffered an NON-undoable operation: fastinit, sc */
...
/* COMDB2 MODIFICATION */
SQLITE_API const dttz_t *SQLITE_STDCALL sqlite3_value_datetime(sqlite3_value*);
SQLITE_API const intv_t *SQLITE_STDCALL sqlite3_value_interval(sqlite3_value*, int type);

SQLITE_API void SQLITE_STDCALL sqlite3_result_datetime(sqlite3_context*, dttz_t*, const char *tz);
SQLITE_API void SQLITE_STDCALL sqlite3_result_interval(sqlite3_context*, intv_t*);
SQLITE_API void SQLITE_STDCALL sqlite3_result_decimal(sqlite3_context*, decQuad*);

SQLITE_API const SQLITE_STDCALL dttz_t *sqlite3_column_datetime(sqlite3_stmt *pStmt, int i);
SQLITE_API const SQLITE_STDCALL intv_t *sqlite3_column_interval(sqlite3_stmt *pStmt, int i, int type);
...
/* COMDB2 Modification: Reset tspec of Prepared Statement. */
SQLITE_API int sqlite3_resetclock(sqlite3_stmt *pStmt);
SQLITE_API char *stmt_tzname(sqlite3_stmt *);
SQLITE_API void stmt_set_dtprec(sqlite3_stmt *, int);
...
**
*/
SQLITE_API int SQLITE_STDCALL sqlite3_stmt_has_remotes(sqlite3_stmt *stmt);
