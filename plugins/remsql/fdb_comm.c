...
int fdb_send_2pc_begin(struct sqlclntstate *clnt, fdb_msg_t *msg, fdb_tran_t *trans, enum transaction_level lvl, int flags, char *dist_txnid,
                       char *coordinator_dbname, char *coordinator_tier, int64_t timestamp, SBUF2 *sb)
{
    int rc;
