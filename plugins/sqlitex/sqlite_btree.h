...
int sqlite3BtreeOpen(
  sqlitex_vfs *pVfs,       /* VFS to use with this b-tree */
  const char *zFilename,   /* Name of database file to open */
  sqlitex *db,             /* Associated database connection */
...
int sqlite3BtreeSetCacheSize(Btree*,int);
  ...
  int sqlite3BtreeSetMmapLimit(Btree*,sqlitex_int64);
#endif
...
int sqlitexUnlockBerkTables(int nTables, void *locks); /* COMDB2 */
...
int sqlite3BtreePayloadSize(BtCursor*);
...
int sqlitexHeaderSizeBtree(void);
...
*/
  ...
  void sqlite3BtreeEnterAll(sqlitex*);
#else
...
# define sqlite3BtreeEnterAll(X)
  ...
  void sqlite3BtreeLeaveAll(sqlitex*);
#ifndef NDEBUG
  /* These routines are used inside assert() statements only. */
  int sqlite3BtreeHoldsMutex(Btree*);
  int sqlite3BtreeHoldsAllMutexes(sqlitex*);
  int sqlitexSchemaMutexHeld(sqlitex*,int,Schema*);
#endif
#else
...
# define sqlitexSchemaMutexHeld(X,Y,Z) 1
#endif
