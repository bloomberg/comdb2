...
int __txn_regop_gen_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int64_t *, u_int32_t,  u_int32_t, u_int32_t, u_int64_t, const DBT *, u_int64_t, void *));
int __txn_regop_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int64_t *, u_int32_t, u_int32_t, int32_t, const DBT *, u_int64_t));
...
int __txn_regop_rowlocks_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int64_t *, u_int32_t, u_int32_t, u_int64_t, DB_LSN *, DB_LSN *,u_int64_t, u_int32_t, u_int32_t, const DBT *, const DBT *, u_int64_t, void *));
