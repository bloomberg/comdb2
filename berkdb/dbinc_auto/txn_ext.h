...
int __txn_regop_detached_child_log __P((DB_ENV *, DB_TXN *, DB_LSN *, u_int64_t *, u_int32_t,  u_int32_t, u_int32_t, u_int32_t, u_int64_t, const DBT *, void *));
...
int __txn_regop_detached_child_read __P((DB_ENV *, void *, __txn_regop_detached_child_args **));
...
int __txn_regop_detached_child_recover __P((DB_ENV *, DBT *, DB_LSN *, db_recops, void *));
...
int __txn_track_alloced_page __P((DB_ENV *, DB_TXN *, DB *, db_pgno_t));
int __txn_track_freed_page __P((DB_ENV *, DB_TXN *, DB *, db_pgno_t));
int __txn_concat_page_lists __P((DB_ENV *, DB_TXN *));
int __txn_freepages __P((DB_ENV *, DB_TXN *));
int __txn_clear_alloced_page_list __P((DB_ENV *, DB_TXN *));
int __txn_clear_free_page_list __P((DB_ENV *, DB_TXN *));
int __txn_reclaim_alloced_pages __P((DB_ENV *, DB_TXN *));
