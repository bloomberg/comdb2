...
/*
 * __lock_assert_none_pp --
 *  DB_ENV->lock_assert_none pre/post processing.
 *
 * PUBLIC: int __lock_assert_none_pp __P((DB_ENV *));
 */
int
__lock_assert_none_pp(dbenv)
	DB_ENV *dbenv;
{
	int rep_check;
	PANIC_CHECK(dbenv);
