...
4. Add _/opt/bb/bin_ to your PATH
...
7. On one machine (say machine-1), create a database - this example creates a database
   ...
   Note: the `--dir PATH` parameter is optional, and if it is omitted comdb2 uses a default root of _/opt/bb/var/cdb2/_ for creating a database directory to contain the database files, which is named as per the database name parameter; hence in this case _/opt/bb/var/cdb2/testdb_.  
...
10. On all nodes, start the database.
    ...
    Note: the log dir comdb2 uses by default is _/opt/bb/var/log/cdb2/_
...
11. On any node, start using the database. You don't have any tables yet. You can add them with _cdb2sql_
    Example -
