...
set syntax_linkage(index-column-list) {{} {alter-table-ddl create-index foreign-key-def table-constraint upsert-clause}}
...
set syntax_linkage(schemachange) {{} sql-stmt}
...
set syntax_linkage(sql-stmt) {{alter-table analyze begin-stmt commit-stmt create-lua-func create-proc create-table create-time-part delete-stmt-limited drop exec-procedure get grant-revoke host-config insert-stmt put rebuild rollback-stmt schemachange select-stmt set-stmt truncate update-stmt-limited} {}}
...
set syntax_linkage(upsert-clause) {{expr index-column-list} insert-stmt}
