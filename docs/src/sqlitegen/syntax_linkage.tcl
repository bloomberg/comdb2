...
set syntax_linkage(expr) {{literal-value select-stmt type-name} {alter-table-ddl column-constraint compound-select-stmt create-index delete-stmt-limited factored-select-stmt insert-stmt join-constraint key-section ordering-term result-column select-core select-stmt simple-select-stmt table-constraint table-or-subquery update-stmt-limited}}
...
set syntax_linkage(insert-stmt) {{expr select-stmt with-clause} sql-stmt}
...
set syntax_linkage(select-stmt) {{common-table-expression compound-operator expr join-clause ordering-term result-column table-or-subquery} {common-table-expression expr insert-stmt sql-stmt table-or-subquery with-clause}}
