...
SELECT '---- DRQS#173040910 ----';
CREATE TABLE t1(i INT UNIQUE, j INT UNIQUE)$$
INSERT INTO t1 VALUES(1,1);
INSERT INTO t1 VALUES (2,2);

# Conflist on (i) -> UPDATE -> j=j+1 -> 2 -> Dup error
INSERT OR IGNORE INTO t1 VALUES(1,1) ON CONFLICT(i) DO UPDATE SET j = j+1;

# Conflict on (i) -> UPDATE (No error)
INSERT OR IGNORE INTO t1 VALUES(1,1) ON CONFLICT(i) DO UPDATE SET j=j+10;
SELECT * FROM t1 ORDER BY 1;

# Conflict on (i) -> IGNORE (No error)
INSERT OR IGNORE INTO t1 VALUES(3,2) ON CONFLICT(i) DO UPDATE SET j=j+10;
SELECT * FROM t1 ORDER BY 1;
