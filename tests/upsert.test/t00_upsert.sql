...
SELECT '---- UPSERT & DATACOPY ----' as test;
CREATE TABLE t1(i INT, j INT, k INT)$$
CREATE UNIQUE INDEX idx1 ON t1(i, j) INCLUDE ALL;
SELECT csc2 FROM sqlite_master WHERE name like 't1';
INSERT INTO t1 VALUES(1,1,1), (2,2,2), (3,3,3);
INSERT INTO t1 VALUES(1,1,1);
INSERT INTO t1 VALUES(1,1,1) ON CONFLICT(i,j) DO UPDATE set k=k+1;
SELECT * FROM t1;
DROP TABLE t1;

SELECT '---- INSERT OR IGNORE & INSERT OR REPLACE ----' as test;
CREATE TABLE t1(i INT UNIQUE, j INT)$$
INSERT INTO t1 VALUES(1,1), (2,2), (3,3);
INSERT INTO t1 VALUES(1,2);
INSERT OR IGNORE INTO t1 VALUES(1,2);
SELECT * FROM t1 ORDER by i;
INSERT OR REPLACE INTO t1 VALUES(1,2);
SELECT * FROM t1 ORDER by i;
DROP TABLE t1;

SELECT '---- INSERT OR IGNORE over non-UNIQNULLS INDEX ----' as test;
CREATE TABLE t1 { schema { int i null=yes } keys { "idx" = i } } $$
...
SELECT '---- UPSERT + NULLs with uniqnulls index ----' as test;
CREATE TABLE t1 { schema { int a null=yes } keys { uniqnulls "idx" = a } } $$
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=1
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=2
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=3
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=4
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=5
SELECT * FROM t1 ORDER by a;
DROP TABLE t1;

SELECT '---- UPSERT + NULLs with non-uniqnulls index ----' as test;
CREATE TABLE t1 { schema { int a null=yes } keys { "idx" = a } } $$
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=1
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=2
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=3
INSERT INTO t1 VALUES(NULL) ON CONFLICT(a) DO UPDATE SET a=4
...
SELECT '--- Test partial-index ----' as test;
CREATE TABLE t1(i INT)$$
CREATE UNIQUE INDEX idx1 ON t1(i) WHERE i > 0;
INSERT INTO t1 VALUES(0);
INSERT INTO t1 VALUES(0);
INSERT INTO t1 VALUES(1);
INSERT INTO t1 VALUES(1);
INSERT INTO t1 VALUES(1) ON CONFLICT DO NOTHING;
INSERT INTO t1 VALUES(1) ON CONFLICT(i) DO NOTHING;
INSERT INTO t1 VALUES(1) ON CONFLICT(i) WHERE i > 1 DO NOTHING;
INSERT INTO t1 VALUES(1) ON CONFLICT(i) WHERE i > 0 DO NOTHING;
SELECT * FROM t1 ORDER BY i;
DROP TABLE t1;

SELECT '---- UPSERT + IGNORE ----';
CREATE TABLE t1(i INT UNIQUE, j INT UNIQUE)$$
INSERT INTO t1 VALUES(1,1);

INSERT INTO t1 VALUES(1,1) ON CONFLICT DO NOTHING;

# Conflict on both (i) and (j)
INSERT INTO t1 VALUES(1,1) ON CONFLICT DO NOTHING;
INSERT INTO t1 VALUES(1,1) ON CONFLICT(i) DO NOTHING;

# Conflict only on (i)
INSERT INTO t1 VALUES(1,2) ON CONFLICT DO NOTHING;
INSERT INTO t1 VALUES(1,2) ON CONFLICT(i) DO NOTHING;

# Conflict only on (j)
INSERT INTO t1 VALUES(2,1) ON CONFLICT DO NOTHING;
INSERT INTO t1 VALUES(2,1) ON CONFLICT(i) DO NOTHING;
