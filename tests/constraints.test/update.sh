...
cdb2sql ${CDB2_OPTIONS} $DB default "drop table pk" &> /dev/null
cdb2sql ${CDB2_OPTIONS} $DB default "drop table fk" &> /dev/null

cdb2sql ${CDB2_OPTIONS} $DB default "create table pk { `cat pk.csc2 ` }" &> /dev/null
cdb2sql ${CDB2_OPTIONS} $DB default "create table fk { `cat fk.csc2 ` }" &> /dev/null
