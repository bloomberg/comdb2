...
CREATE TABLE t1(i INT, j INT)$$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 ALTER COLUMN j SHORT $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 ALTER COLUMN j INT DEFAULT 0 $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 ALTER COLUMN j INT NOT NULL DEFAULT 0 $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 DROP COLUMN j, ADD COLUMN j int $$
DROP TABLE t1;

CREATE TABLE t1(i INT)$$
ALTER TABLE t1 ALTER COLUMN i SHORT $$
ALTER TABLE t1 ALTER COLUMN i INT, DROP COLUMN i $$
ALTER TABLE t1 ALTER COLUMN ii $$
ALTER TABLE t1 ALTER COLUMN ii INT $$
ALTER TABLE t1 ALTER COLUMN i INT, DROP COLUMN i, ADD COLUMN i INT $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
DROP TABLE t1;

CREATE TABLE t1(i INT, j INT)$$
ALTER TABLE t1 ALTER COLUMN j SHORT, DROP COLUMN j $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 ADD j INT, DROP COLUMN j $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
ALTER TABLE t1 ALTER ADD j INT, ALTER COLUMN j SHORT $$
ALTER TABLE t1 ADD j INT, ALTER COLUMN j SHORT $$
SELECT csc2 FROM sqlite_master WHERE name LIKE 't1';
DROP TABLE t1;
