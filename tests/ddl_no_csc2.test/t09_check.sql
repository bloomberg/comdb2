...
SELECT '10. Check during FK cascade' as test;
CREATE TABLE t1(i INT UNIQUE)$$
CREATE TABLE t2(i INT UNIQUE, FOREIGN KEY (i) REFERENCES t1(i) ON UPDATE CASCADE, CONSTRAINT valid_pct CHECK (i BETWEEN 0 AND 100))$$
SELECT csc2 FROM sqlite_master WHERE name = 't1';
SELECT csc2 FROM sqlite_master WHERE name = 't2';
INSERT INTO t1 VALUES(1);
INSERT INTO t2 VALUES(1);
# This must fail
UPDATE t1 SET i=110 WHERE i=1;
SELECT * FROM t1;
SELECT * FROM t2;
DROP TABLE t2;
DROP TABLE t1;

SELECT '10. Test for NULLs' as test;
CREATE TABLE t1(v VARCHAR(10), CHECK (NULL))$$
INSERT INTO t1 VALUES(NULL);
INSERT INTO t1 VALUES('aaa');
SELECT * FROM t1 ORDER BY 1;

CREATE TABLE t2(v VARCHAR(10), CHECK (v LIKE 'aaa%'))$$
INSERT INTO t2 VALUES(NULL)
INSERT INTO t2 VALUES('aaa');
INSERT INTO t2 VALUES('aaaa');
INSERT INTO t2 VALUES('baaa');
SELECT * FROM t2 ORDER BY 1;

CREATE TABLE t3(v VARCHAR(10), CHECK (v IS NOT NULL))$$
