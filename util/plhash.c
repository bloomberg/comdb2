...
{
    return hash_init_user((hashfunc_t *)hash_default_strcaselen, (cmpfunc_t *)hash_default_strcasecmp, keyoff, 0);
}

static unsigned int hash_default_strcaseptrlen(const unsigned char **keyp, int len __attribute_unused__)
{
    return hash_default_strcaselen(*keyp, 0);
}

static int hash_default_strcaseptrcmp(const char **a, const char **b, int len __attribute_unused__)
{
    return strcasecmp(*a, *b);
}
...
{
    return hash_init_user((hashfunc_t *)hash_default_strcaseptrlen, (cmpfunc_t *)hash_default_strcaseptrcmp, keyoff, 0);
}
