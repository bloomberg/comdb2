...
static void handle_ssl_lib_errors(SBUF2 *sb, int sslliberr, int nwritten)
{
    switch (sslliberr) {
...
static int handle_sslio_rw_errors(SBUF2 *sb, int err, int nwritten, int *wantread, int *wantwrite)
{
    switch (err) {
