...
add_to_hash("&bdb_state->last_dta_lk");
add_to_hash("&bdb_state->pending_broadcast_lock");
add_to_hash("&(bdb_state->pthread_attr_detach)");
add_to_hash("&bdb_state->pthread_attr_detach");
add_to_hash("&(bdb_state->seed_lock)");
add_to_hash("bdb_state->seqnum_info->key");
add_to_hash("berkdb_thread_stats_key");
add_to_hash("&bhp->mutex");
add_to_hash("CHR_DATADD");
add_to_hash("CHR_IXADDK");
add_to_hash("CHR_TMPSVOP");
add_to_hash("&clnt->dtran_mtx");
add_to_hash("&clnt->state_lk");
add_to_hash("&clnt->wait_cond");
add_to_hash("&clnt->wait_mutex");
add_to_hash("&clnt->write_cond");
add_to_hash("&clnt->write_lock");
add_to_hash("&coalesce_wakeup");
add_to_hash("comdb2_open_key");
add_to_hash("&commit->mutex");
add_to_hash("&cond");
add_to_hash("&current_sql_query_key");
add_to_hash("dbenv->dblist_mutexp");
add_to_hash("&dbenv->dbreglk");
add_to_hash("&dbenv->lc_cache.lk");
add_to_hash("&dbenv->mintruncate_lk");
add_to_hash("&dbenv->recoverlk");
add_to_hash("DBG_FREE_CURSOR");
add_to_hash("dblp->mutexp");
add_to_hash("&(&dblp->reginfo)->rp->mutex");
add_to_hash("dbmp->mutexp");
add_to_hash("&(dbmp->reginfo)->rp->mutex");
add_to_hash("dbp->free_mutexp");
add_to_hash("dbp->mutexp");
add_to_hash("db_rep->rep_mutexp");
add_to_hash("&entry->cond");
add_to_hash("&entry->mtx");
add_to_hash("&entry->rawtotals.lk");
add_to_hash("flush_mutexp");
add_to_hash("&gbl_logput_cond");
add_to_hash("&(host_node_ptr->ack_wakeup)");
add_to_hash("&(host_node_ptr->throttle_wakeup)");
add_to_hash("&(host_node_ptr->write_wakeup)");
add_to_hash("&hp->hash_mutex");
add_to_hash("key");
add_to_hash("&lcc->lk");
add_to_hash("lock_key");
add_to_hash("&lp->fq_mutex");
add_to_hash("&lp[i].lsns_mtx");
add_to_hash("&lp[i].mutex");
add_to_hash("&(&lt->reginfo)->rp->mutex");
add_to_hash("&(memreg)->rp->mutex");
add_to_hash("&mfp->mutex");
add_to_hash("mgr->mutexp");
add_to_hash("&(&mgr->reginfo)->rp->mutex");
add_to_hash("&mutexp->cond");
add_to_hash("&mutexp->mutex");
add_to_hash("&newl->mutex");
add_to_hash("&op->unexhausted");
add_to_hash("parent->tid_key");
add_to_hash("&pt->lk");
add_to_hash("&pt->wait");
add_to_hash("query_info_key");
add_to_hash("&range->t->wait");
add_to_hash("&renv->mutex");
add_to_hash("&rp->mutex");
add_to_hash("&rq->clients_mtx");
add_to_hash("&rq->completed_lock");
add_to_hash("&rq->cond");
add_to_hash("&sc_async_cond");
add_to_hash("&sc->condStart");
add_to_hash("&sched->cond");
add_to_hash("&sc->livesc_mtx");
add_to_hash("&sc->mtx");
add_to_hash("&sc->mtxStart");
add_to_hash("&s->condStart");
add_to_hash("&sess->clients_mtx");
add_to_hash("&sess->completed_lock");
add_to_hash("&sess->cond");
add_to_hash("&sess->mtx");
add_to_hash("&tbl->sc_live_lk");
add_to_hash("&thd->cond");
add_to_hash("&thd->lk");
add_to_hash("&thd->wakeup");
add_to_hash("thread_util_key");
add_to_hash("thrman_key");
add_to_hash("&timer_attr");
add_to_hash("&t->lk");
add_to_hash("&(&tmgr->reginfo)->rp->mutex");
add_to_hash("&tran->pglogs_mutex");
add_to_hash("&tran->store_mtx");
add_to_hash("unique_tag_key");
